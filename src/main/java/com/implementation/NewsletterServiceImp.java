...
import com.repository.NewsletterRepository;
...
public class NewsletterServiceImp implements NewsletterService {
	...
	public boolean deleteNews(int id) {
		Newsletter news =  RepoNews.findById(id).orElse(null);
		RepoNews.delete(news);
		return true;
	}

	@Override
	public Newsletter SearchNewsletter(int idNews) {
		Newsletter news =  RepoNews.findById(idNews).orElse(null);
		return news;
	}
