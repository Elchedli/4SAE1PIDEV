...
public class DiscussionServiceImp implements DiscussionService {
	...
	@Override
	public List<Profile> FiltrerProfiles(String username) {
		List<Discussion> discUser = ListeDiscussion(username);
...
//		System.out.println("nom : "+newdata[0]+" prenom : "+newdata[1]);
		List<Profile> profileSearch = (List<Profile>) RepoProfile.listerPeople();
//		System.out.println("datas : "+profileSearch);
		List<Profile> profileSearchInverse = RepoProfile.listerPeopleInverse();
